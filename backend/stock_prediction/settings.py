...
SECRET_KEY = 'x)l+g9xoyk=2o%xs98y4f5=pshl!b=gir^t_$7z96#q9$_)x$b'
...
# Since working in localhost, this will disable the CORS feature
# If True, all origins will be accepted ignoring the whitelist
